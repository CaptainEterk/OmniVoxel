...
@Function(id = "shift_b")
public class ShiftBDensityFunction extends DensityFunction {
    private final Noise3D noise;

    public ShiftBDensityFunction(GameNode args, long seed) {
        super(args, seed);
        ...
        this.noise = Noise3DProvider.get(noiseNode.value());
    }

    @Override
    public double evaluate(double x, double y, double z) {
        return noise.generate(z / 4.0, x / 4.0, 0.0) * 4.0;
    }
}
