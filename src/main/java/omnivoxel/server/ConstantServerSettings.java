...
public final class ConstantServerSettings {
    ...
    public static final int CHUNK_QUEUED_LIMIT = CHUNK_GENERATOR_THREAD_LIMIT * CHUNK_GENERATOR_INDIVIDUAL_TASK_COUNT * 5;
    public static final int INFLIGHT_REQUESTS_MINIMUM = CHUNK_QUEUED_LIMIT / 5;
